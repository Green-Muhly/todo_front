...
const Todo = ({ id, title, content, createDate, checked, onToggle, onDelete, onUpdate }) => {
    ...
    return (
        <Container>
            ...
            <Title onClick={() => onModalOpen()}>{content.length > 12 ? `${content.substr(0, 12)}...` : content}</Title>
